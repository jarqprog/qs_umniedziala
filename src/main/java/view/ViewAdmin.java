...
public class ViewAdmin extends View {
    ...
    private ArrayList<String> adminOptions = new ArrayList<String>(Arrays.asList("1. Create mentor",
            "2. Create class", "3. Edit mentor", "4. See mentor's profile",
            "5. Create levels of experience", "0. Log out"));

    private ArrayList <String> editMentorOptions1 = new ArrayList <String>(Arrays.asList("1. Edit mentor's e-mail",
            "2. Edit mentor's class", "0. Go back" ));

    private ArrayList<String> editMentorOptions = new ArrayList<String>(Arrays.asList("1. Unsign mentor from class",
